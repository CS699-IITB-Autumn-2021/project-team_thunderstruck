...
"""
The following script scrapes data from worldometers.com and mygov.in and updates live dash board, at last the function py.plot()
uploads data on the plotly server. plotly express is used to generate plots. 
"""
